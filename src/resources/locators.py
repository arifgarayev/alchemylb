...
class RootLocators:
    ...
    hamburger_menu = "//android.widget.ImageView[@resource-id=\"ru.yandex.taxi:id/hamburger\"]"
...
class SearchModalLocators:
    ...
    origin_text_top = "//android.widget.FrameLayout[@resource-id=\"ru.yandex.taxi:id/source_address_input\"]" \
    ...
    destination_text_bottom = "//android.widget.FrameLayout[@resource-id=\"ru.yandex.taxi:id/destination_address_input\"]" \
                      "/android.widget.LinearLayout/android.widget.FrameLayout[@resource-id=\"ru.yandex.taxi:id/address_select_input\"]" \
                      "/android.view.ViewGroup/android.widget.LinearLayout[@resource-id=\"ru.yandex.taxi:id/component_input_center\"]" \
                      "/android.widget.LinearLayout/android.widget.EditText[@resource-id=\"ru.yandex.taxi:id/component_list_item_input\"]"
...
class ModalLocators:
    ...
    economy_class = "//android.widget.Button[contains(@content-desc, \"Economy service class\")]"
    comfort_class = "//android.widget.Button[contains(@content-desc, \"Comfort service class\")]"
    comfort_plus_class = "//android.widget.Button[contains(@content-desc, \"Comfort+ service class\")]"

    bottom_sheet = "//android.widget.FrameLayout[@resource-id=\"ru.yandex.taxi:id/slideable_modal_view_bottom_sheet\"]"

    icon = bottom_sheet + "/android.widget.FrameLayout[@resource-id=\"ru.yandex.taxi:id/slideable_modal_view_card_content_container\"]/android.widget.LinearLayout[@resource-id=\"ru.yandex.taxi:id/content\"]/android.widget.LinearLayout/android.widget.Button[@resource-id=\"ru.yandex.taxi:id/yourself\"]"
